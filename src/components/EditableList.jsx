...
const EditableList = () => {
  ...
  return (
    <div className="bg-[#ffe5d6] py-5">
      <div className="w-[90%] mx-auto">
        <h1 className="text-4xl text-center mx-auto mt-5 font-semibold border-b-2 border-black pb-2">
          Unleash the Hero in you!
        </h1>
        <p className="text-3xl text-center font-medium mx-auto mt-5">
          Add your favorite superheroes to our growing roster and be a part of
          our super-powered community.
        </p>
        <p className="text-2xl text-center mx-auto mt-5 font-normal">
        ...
        <h1 className="text-4xl text-center mx-auto mt-5 font-semibold bg-black text-white py-3 rounded-full">
